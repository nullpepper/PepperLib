 ...
 *
 * <p><b>能力声明</b>：本类型标注 {@link ltd.pepper.lib.runtime.MinMinecraftVersion
 ...
 * {@code ltd.pepper.lib.task.PepperScheduler}）。</p>
 *
 ...
 * {@code ltd.pepper.lib.*} 类（PepperLib 前置插件）；shade 模式消费者因类重定位，
 * 与服务器注册的 {@code InstanceWorldService} 是不同类型，无法经 ServicesManager
 * 互通——shade 消费者须自带 provider 实现。</p>
 */
@ltd.pepper.lib.runtime.MinMinecraftVersion(value = "1.18", capability = "world-instance")
