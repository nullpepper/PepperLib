...
- [spec] 实现 PepperLib 0.7.0 的 Experimental 世界实例能力：核心 ltd.pepper.lib.world 公共 API（双消费者共设计：PVP/PVE 竞技场插件，语义一致：结束→清场→卸载）+ 独立 pepper-l…
